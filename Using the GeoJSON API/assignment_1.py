...
# To call the API, you need to provide a sensor=false parameter and the address that you are requesting as the address= parameter that is properly URL encoded using the urllib.parse.urlencode() fuction as shown in http://www.py4e.com/code3/geojson.py
# '''
# Test Location -  "South Federal University"
# Actual Location - "University of Erlangen-Nuremberg"
